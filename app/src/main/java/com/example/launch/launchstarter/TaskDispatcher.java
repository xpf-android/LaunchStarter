package com.example.launch.launchstarter;
...
import com.example.launch.launchstarter.sort.TaskSortUtil;
import com.example.launch.launchstarter.stat.TaskStat;
import com.example.launch.launchstarter.task.DispatchRunnable;
import com.example.launch.launchstarter.task.Task;
import com.example.launch.launchstarter.task.TaskCallBack;
import com.example.launch.launchstarter.utils.DispatcherLog;
...
public class TaskDispatcher {
    ...
    public static void init(Context context) {
        if (context != null) {
            sContext = context;
            sHasInit = true;
            sIsMainProcess = ProcessUtil.isMainProcess(sContext);
        }
    }
